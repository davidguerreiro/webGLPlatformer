...
public class World6Intro : MonoBehaviour
{
    public string sceneToLoadAfterCinematic;

    [Header("Components")]
    public CinematicManager cinematicManager;
    public DarkPortal darkPortalBottom;
    public DarkPortal darkPortalTop;
    ...
    public IEnumerator PlayCinematicRoutine()
    {
        ...
        darkPortalBottom.Appear();
        yield return new WaitForSeconds(.5f);
        falseijo.SetActive(true);
        yield return new WaitForSeconds(1.5f);
        darkPortalBottom.Dissapear();
        ...
        falseijoActor.ChangeSprite(2);
        falseijoActor.EnableOtherComponents(0);
        falseijoActor.MoveActor(0, false);
        ...
        darkPortalTop.Appear();
        yield return new WaitForSeconds(1f);
        falseijo.SetActive(false);
        yield return new WaitForSeconds(1f);
        darkPortalTop.Dissapear();
